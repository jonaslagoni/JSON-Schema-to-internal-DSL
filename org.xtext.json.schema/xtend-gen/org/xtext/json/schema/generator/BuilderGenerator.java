...
public class BuilderGenerator {
  ...
  public CharSequence generateBuilder(final CustomModel model) {
    ...
    String _firstUpper_2 = StringExtensions.toFirstUpper(model.getParentName());
    _builder.append(_firstUpper_2);
    _builder.append("Builder;");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("public class ");
    String _firstUpper_3 = StringExtensions.toFirstUpper(model.getName());
          ...
          if (((schema != null) && (schema.getType() != null))) {
            {
              ...
              if (_isObject) {
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                String _firstLower_4 = StringExtensions.toFirstLower(model.getName());
                  ...
                  for(final JsonTypes type : _jsonTypes) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      if ((schemaJsonType != null)) {
                        ...
                        _builder.append(" ");
                        String _firstLower_7 = StringExtensions.toFirstLower(GeneratorUtils.realizeName(property.getName()));
                        _builder.append(_firstLower_7);
                        _builder.append("){");
                        _builder.newLineIfNotEmpty();
                        _builder.append("\t");
                        String _firstLower_8 = StringExtensions.toFirstLower(model.getName());
                        _builder.append(_firstLower_8, "\t");
                        _builder.append(".set");
                        String _firstUpper_9 = StringExtensions.toFirstUpper(GeneratorUtils.realizeName(property.getName()));
                        _builder.append(_firstUpper_9, "\t");
                        _builder.append("(");
                        String _firstLower_9 = StringExtensions.toFirstLower(GeneratorUtils.realizeName(property.getName()));
